...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _reactImage = __webpack_require__(25);

	var _reactImage2 = _interopRequireDefault(_reactImage);

	var _EventFeatured = __webpack_require__(122);

	var _EventFeatured2 = _interopRequireDefault(_EventFeatured);

	var _EventContent = __webpack_require__(123);

	var _EventContent2 = _interopRequireDefault(_EventContent);

	var _EventBooking = __webpack_require__(124);

	var _EventBooking2 = _interopRequireDefault(_EventBooking);
	...
	var EventList = function (_React$Component) {
	  ...
	  function EventList(props) {
	    ...
	    _this.state = { events: [], provider: 'Yogashop', startDateTime: '2018-03-26' };
	  ...
	  _createClass(EventList, [{
	    ...
	    value: function render() {
	      var stateExist = this.state.events.length;
	      if (!stateExist) {
	        return _react2.default.createElement(
	          'div',
	          { className: 'wrapper wrapper__normal' },
	          _react2.default.createElement(_Search2.default, { updateTheSearch: this.updateSearch.bind(this), onClick: this.updateSearch.bind(this) }),
	          _react2.default.createElement(
	            'h3',
	            { className: 'not-found' },
	            ' Unfortunately there are no events found. Please try again later. '
	          )
	        );
	      }
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement('p', { className: 'border' }),
	        this.state.events.map(function (item, index) {
	          return _react2.default.createElement(
	            'div',
	            { className: 'row row__gutters event' },
	            _react2.default.createElement(_EventFeatured2.default, { key: 'EventFeatured' + index, event: item }),
	            _react2.default.createElement(_EventContent2.default, { key: 'EventContent' + index, event: item }),
	            _react2.default.createElement(_EventBooking2.default, { key: 'EventBooking' + index, event: item })
	          );
	        })
	      );
	    }
	    ...
	    value: function updateSearch() {
	      var provider = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.state.provider;
	      var startDateTime = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.state.startDateTime;
	    ...
	    value: function Search() {
	      ...
	      var ProviderName = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'Yogashop';
	      var FromDate = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '2018-04-21';

	      /*1- fetch the data from https://api.fitogram.pro  */
	      fetch('https://api.fitogram.pro/providers/' + ProviderName + '/events/public?from=' + FromDate).then(function (result) {
	        return result.json();
	      }).then(function (events) {
	        return _this2.setState({ events: events });
	      }).then(function () {
	        ...
	        _this2.setState({ date: date, time: time });
	        var newState = Object.assign({}, _this2.state.events);
	        _this2.state.events.map(function (item, index) {
	...
	_reactDom2.default.render(_react2.default.createElement(EventList, null), document.getElementById('root'));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__webpack_require__(35)(IteratorPrototype, __webpack_require__(90)('iterator'), function () { return this; });
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function (test, buggy, set) {
	      try {
	        set = __webpack_require__(33)(Function.call, __webpack_require__(105).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var EventFeatured = function (_React$Component) {
	  _inherits(EventFeatured, _React$Component);

	  function EventFeatured(props) {
	    _classCallCheck(this, EventFeatured);

	    var _this = _possibleConstructorReturn(this, (EventFeatured.__proto__ || Object.getPrototypeOf(EventFeatured)).call(this, props));
	  ...
	  _createClass(EventFeatured, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'row__40 event__featured' },
	        _react2.default.createElement(
	          'h2',
	          { className: 'event__name' },
	          ' ',
	          this.props.event.name ? this.props.event.name : this.state.default.name,
	          ' '
	        ),
	        _react2.default.createElement(_reactImage2.default, { className: 'event__featured__image',
	          src: this.props.event.eventGroup.imageUrl ? this.props.event.eventGroup.imageUrl : this.state.default.src })
	      );
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var EventContent = function (_React$Component) {
	  _inherits(EventContent, _React$Component);

	  function EventContent(props) {
	    _classCallCheck(this, EventContent);

	    var _this = _possibleConstructorReturn(this, (EventContent.__proto__ || Object.getPrototypeOf(EventContent)).call(this, props));

	    _this.state = { description: '', clicked: 'no', text: '...more', counter: 0,
	      default: {
	        info: 'Yoga class',
	        date: 'N/A',
	        time: '12:00',
	  ...
	  _createClass(EventContent, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      var description = this.props.event.descriptions[0].text.replace(/<(?:.|\n)*?>/gm, '');
	    ...
	    key: 'render',
	    value: function render() {
	      var initials = this.props.event.trainers[0].name + '  ';
	      initials = initials.split(' ');
	      var description = this.state.description;

	      return _react2.default.createElement(
	        'div',
	        { className: 'row__40 event__content' },
	        _react2.default.createElement(
	          'div',
	          { className: 'row row__gutters row__b-margin ' },
	          _react2.default.createElement(
	            'p',
	            { className: 'row__50 event__date font' },
	            _react2.default.createElement('small', { className: ' fa fa-clock-o' }),
	            ' ',
	            _react2.default.createElement(
	              'strong',
	              null,
	              ' ',
	              this.props.event.date ? this.props.event.date : this.state.default.date,
	              ' '
	            ),
	            ' ',
	            _react2.default.createElement(
	              'small',
	              { className: 'time' },
	              this.props.event.time ? this.props.event.time : this.state.default.time,
	              ' Uhr '
	            ),
	            '  '
	          ),
	          _react2.default.createElement(
	            'p',
	            { className: 'row__50 event__info font' },
	            ' ',
	            _react2.default.createElement('i', { className: ' fa fa-info-circle' }),
	            this.props.event.name ? this.props.event.name : this.state.default.info,
	            ' '
	          )
	        ),
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'p',
	            { className: 'row__50 event__place font' },
	            ' ',
	            ...
	            ', ',
	            this.props.event.location.street,
	            ' '
	          ),
	          _react2.default.createElement(
	            'p',
	            { className: 'row__50 event__instructor font' },
	            ' ',
	            _react2.default.createElement(
	              'a',
	              { href: this.props.event.trainers[0].imageUrl },
	              ' ',
	              _react2.default.createElement(
	                'i',
	                { className: ' event__instructor__before' },
	                ' ',
	                initials[0][0],
	                ' ',
	                initials[1][0]
	              ...
	              ' ',
	              this.props.event.trainers[0].name,
	              ' '
	            ),
	            ' '
	          )
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'event__description font' },
	          _react2.default.createElement(
	            'p',
	            null,
	            ' ',
	            ...
	            _react2.default.createElement(
	              'span',
	              { onClick: this.onClick, className: 'more' },
	              ' ',
	              description.length > 30 ? this.state.text : '',
	              ' '
	            )
	          )
	        )
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var EventBooking = function (_React$Component) {
	  _inherits(EventBooking, _React$Component);

	  function EventBooking() {
	    _classCallCheck(this, EventBooking);

	    return _possibleConstructorReturn(this, (EventBooking.__proto__ || Object.getPrototypeOf(EventBooking)).apply(this, arguments));
	  }

	  _createClass(EventBooking, [{
	    key: 'render',
	    value: function render() {
	      var seats = this.props.event.seats;
	      var booked = this.props.event.seatsBooked;
	      var verfügbar = seats - booked;
	      return _react2.default.createElement(
	        'div',
	        { className: 'row__auto row__20__t-margin event__booking  ' },
	        _react2.default.createElement(
	          'p',
	          { className: ' event__available font ' },
	          ' ',
	        ...
	        _react2.default.createElement(
	          'button',
	          { className: 'btn btn__small btn__centered btn__100 row__b-margin row__t-margin ' },
	          _react2.default.createElement(
	            'a',
	            { className: 'default', href: 'https://www.fitogram.pro/preise/' },
	            ' Zur Buchung '
	          )
	        ),
	        _react2.default.createElement(
	          'p',
	          { className: 'event__deadline font' },
	          ' Buchung bis: ',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Search = function (_React$Component) {
	  ...
	  function Search(props) {
	    ...
	    _this.state = { providerName: '', fromDate: '' };
	    _this.handleProviderChange = _this.handleProviderChange.bind(_this);
	  ...
	  _createClass(Search, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'form',
	          { onSubmit: this.handleSearch, className: 'row row__gutters search__form' },
	          _react2.default.createElement('input', { type: 'text', onChange: this.handleProviderChange.bind(this),
	            value: this.state.providerName, placeholder: 'EX: Yogashop', className: '  search__provider' }),
	          _react2.default.createElement('input', { type: 'text', onChange: this.handleDateChange.bind(this),
	            value: this.state.fromDate, placeholder: 'EX: 2018-03-26', className: '  search__date' }),
	          _react2.default.createElement(
	            'button',
	            { value: 'Search', className: 'search__submit btn btn__100 btn__small' },
	            'Search '
	          )
	        )
	      );
	    ...
	    value: function handleProviderChange(e) {
	      this.setState({ providerName: e.target.value });
	      var date = this.state.fromDate ? this.state.fromDate : '2018-03-26';
	    ...
	    value: function handleDateChange(e) {
	      ...
	      var provider = this.state.providerName ? this.state.providerName : 'Yogashop';
