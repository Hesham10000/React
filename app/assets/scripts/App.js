      ...
      if(!stateExist){
        return(
          <div className="wrapper wrapper__normal">
              <Search updateTheSearch={this.updateSearch.bind(this)} onClick={this.updateSearch.bind(this)} />
...
updateSearch(provider=this.state.provider,startDateTime=this.state.startDateTime){
